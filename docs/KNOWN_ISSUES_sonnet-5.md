...
- **§1 分布**（2026-08-23 全面复核并闭环 1.40/1.45/1.47 后重算）：**高危 0 项**、中危 2 项、低危 12 项，合计 **14 条**。`1.40`（工具 ID 归一化下沉 `chatmsg`）、`1.45`（Quota 孤儿 Key 修剪）与 `1.47`（Server 审计路径收敛）已全部完成落地并移入 §3；`1.21`/`1.28`/`1.31`（P7）、`1.19`（P8）、`1.30`/`1.33`/`1.34`（P9）、`1.39`（P11）、`1.41`/`1.37`（P12）、`1.35`/`1.36`（P13）、`1.38`/`1.42`/`1.43`（P14/P15）已修复并移入 §3；原 `1.24`、`1.5`、`1.15`、`1.27` 与 `1.46` 经重新分类后移入 §2；原 `1.23` 已并入 `1.1`。
