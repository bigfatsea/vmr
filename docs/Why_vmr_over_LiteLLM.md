...
Simplicity isn't just a design preference here — it's cheap in practice too: load-tested at up to 150 req/s, vmr's own routing overhead sits at single-digit milliseconds (p95) on 9 of 12 tested scenarios ([`loadtest/`](../loadtest/)).
