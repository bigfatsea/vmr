...
# api_keys:                    # optional: additional credentials, each tagged in `vmr report` output
#   - ${VMR_KEY_ALICE}          # by its own tail (see "Multiple callers, one instance" below) — works
#   - ${VMR_KEY_OPENCLAW}       # alongside api_key, which stays a valid, untagged catch-all
