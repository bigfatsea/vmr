...
- `vmr analyze` third honesty + labelling pass (from `ANALYZE_SAMPLE_REPORTS_REVIEW` part 4, first tier):
...
- `vmr analyze` source-level second-pass fixes (from `ANALYZE_SAMPLE_REPORTS_REVIEW` part 6):
