...
func writeReport(results []roundResult, byModel, endpoints string) error {
	...
	fmt.Fprintf(&b, "Design and how to read this: [`docs/VirtualModelRouter_Design_v4_Core.md`](../docs/VirtualModelRouter_Design_v4_Core.md) §12, [`loadtest/README.md`](../loadtest/README.md). %d load rounds against the same 11 scenarios.\n\n", len(results))
