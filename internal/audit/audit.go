...
type Record struct {
	...
	// Guard is Agent Guard's forensic metadata for this request (see
	// guard.go) — nil when the guard: config key is absent entirely;
	// server/router stamp it on both the outbound and inbound paths when
	// configured.
