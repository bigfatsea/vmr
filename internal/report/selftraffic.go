// Ver 2026-09-23 04:02, by Claude Opus 5.5

// Self-traffic exclusion: the SessionAnalysis-level half of it —
...
// flat slices buildTools/buildCompactions read directly,
...
// left untouched: rep.Sessions is already correctly filtered because
